...
For physical location of phases $\omega_r$,  %%completar
\begin{multline}
    [\overset{-}{C}] = [S] [\overset{-}{B}] \\
    = \sqrt*{\Big( \dfrac{2}{3} \Big)}
    \begin{bmatrix}
...
Consider the particular  case of physical phase layout $\omega_r$ and positive phase sequence currents. %%completar
