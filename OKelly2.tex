...
\subsubsection{\textit{Rotor self-inductances}} Referring to Fig. 8.2, the instantaneous phase m.m.f.\ $F_a$ is resolved into $d$-axis and $q$-axis components.
\begin{equation}
    \begin{aligned}
        F_{d\textup{a}} & = F_{\textup{a}} \cos \theta_r = N_1 i_a \cos \theta_r \\
        F_{qa} & = - F_a \sin \theta_r = - N_1 i_a \sin \theta_r
    \end{aligned}
    \label{eq:Eq8.1}
\end{equation}
$F_{da}$ and $F_{qa}$ are assumed to act respectively on main gap permeances $\Lambda d$ and $\Lambda q$.

Phase $a$, $d$-$q$ axis flux-linkages
\begin{equation}
    \begin{aligned}
        \varPsi_{da} & = N_1 \Lambda_d F_{da} = {(N_1)}^2 \Lambda_d i_a \cos \theta_r \\
\varPsi_{qa} & = N_1 \Lambda_q F_{qa} = - {(N_1)}^2 \Lambda_q i_a \sin \theta_r 
    \end{aligned}
    \label{eq:Eq8.2}
\end{equation}
...
\begin{equation}
    \varPsi_{qa} = \varPsi_{da} \cos \theta_r - \varPsi_{qa} \sin \theta_r
    \label{eq:Eq8.3}
\end{equation}

From (8.2) and (8.3)
\begin{align}
    \varPsi_{qa} & = {(N_1)}^2(\Lambda_d \cos^2 \theta_r + \Lambda_q \sin^2 \theta_r) \nonumber \\
    & = {(N_1)}^2 i_a \Big[ \Big(\dfrac{\Lambda_d -\Lambda_q}{2}\Big) + \Big( \dfrac{\Lambda_d - \Lambda_q}{2} \Big) \cos 2\theta_r \Big]
    \label{eq:Eq8.4}
\end{align}
...
\begin{equation}
    \varPsi_{la} = N_1 \Lambda_l F_{a} = {(N_1)}^2 \Lambda_l i_a 
    \label{eq:Eq8.5}
\end{equation}

Total flux-linkage
\begin{equation}
    \varPsi_a = \varPsi_{la} + \varPsi_{ga}
    \label{eq:Eq8.6}
\end{equation}

From (8.4) and (8.5)
\begin{equation}
    \varPsi_a = {(N_1)}^2 i_a \Big[ \Lambda_l + \Big( \dfrac{\Lambda_d + \Lambda_q}{2}\Big) + \Big( \dfrac{\Lambda_d - \Lambda_q}{2}\Big) \cos2\theta_r\Big]
    \label{eq:Eq8.7}
\end{equation}
...
\begin{equation}
    \mathcal{L}_{aa} = \dfrac{\varPsi_a}{i_a} = L_l +L_1 +L_2 \cos 2\theta_r
    \label{eq:Eq8.9}
\end{equation}
...
\begin{equation}
    \mathcal{L}_{bb} = \dfrac{\varPsi_a}{i_a} = L_l +L_1 +L_2 \cos 2(\theta_r - 120^{\circ})
    \label{eq:Eq8.10}
\end{equation}
\begin{equation}
    \mathcal{L}_{cc} = \dfrac{\varPsi_a}{i_a} = L_l +L_1 +L_2 \cos 2(\theta_r + 120^{\circ})
    \label{eq:Eq8.11}
\end{equation}
...
Resolving $\varPsi_{da}$ and $\varPsi_{qa}$, from (8.3), along the axis of phase $b$ and summing components to give total flux-linkage with phase $b$,
\begin{align}
    \varPsi_{ba} & = \varPsi_{qa} \cos (\theta_r + 90^{\circ} -120^{\circ}) +\varPsi_{da} \cos(\theta_r - 120^{circ}) \nonumber \\
    \varPsi_{ba} & = -\varPsi_{qa} \sin (\theta_r - 120^{\circ}) + \varPsi_{da} \cos(\theta_r -120^{\circ}) 
    \label{eq:Eq8.12}
\end{align}

Substituting (8.2) in (8.12)
\begin{align}
    \varPsi_{ba} & = {(N_1)}^2 i_a[\Lambda_q \sin(\theta_r -120^{\circ}) \sin \theta_r + \Lambda_d \cos(\theta_r -120^{\circ}) \cos \theta_r] \nonumber \\
    \varPsi_{ba} & = {(N_1)}^2 i_a \Big[ - \Big( \dfrac{\Lambda_d + \Lambda_q}{4} \Big) + \Big( \dfrac{\Lambda_d - \Lambda_q}{2}\Big) \cos 2(\theta_r - 60^{\circ})\Big]
    \label{eq:Eq8.13}
\end{align}
...
\begin{equation}
    \mathcal{L}_{ba} = \mathcal{L}_{ab} = \dfrac{\varPsi_{ba}}{i_a} = \dfrac{-L_1}{2} + l_2 \cos 2(\theta_r - 60^{\circ})
    \label{eq:Eq8.14}
\end{equation}

Expressions for $\mathcal{L}_{cb}$ and $\mathcal{L}_{ac}$ can be written directly by noting in (8.14) that $(\theta_r - 60^{\circ})$ is the angle measured from the $d$-axis to a line bisecting the angle between the axes of phase $a$ and $b$.

Thus, for phases $c$ and $b$ the angle us $(\theta_r - 180^{\circ})$ and for phases $c$ and $a$, $(\theta_r + 60^{\circ})$.
\begin{align}
    \mathcal{L}_{cb} & = \mathcal{L}_{bc} = \dfrac{\varPsi_{cb}}{i_b} = \dfrac{-L_1}{2} \cos 2\theta_r \\
    \mathcal{L}_{ac} & = \mathcal{L}_{ca} = \dfrac{\varPsi_{ac}}{i_c} = \dfrac{-L_1}{2} \cos 2(\theta_r + 60^{\circ}) 
    \label{eq:Eq8.16}
\end{align}
...
\begin{equation}
    \begin{aligned}
        \mathcal{L}_{af} & = \mathcal{L}_{fa} = M_{rf} \cos \theta_r \\
        \mathcal{L}_{bf} & = \mathcal{L}_{fb} = M_{rf} \cos (\theta_r - 120^{\circ}) \\
        \mathcal{L}_{cf} & = \mathcal{L}_{fc} = M_{rf} \cos (\theta_r + 120^{\circ}) \\
    \end{aligned}
    \label{eq:Eq8.17}
\end{equation}
...
\begin{equation}
    \begin{aligned}
        \mathcal{L}_{as} & = \mathcal{L}_{sa} = M_{rs} \cos \theta_r \\
        \mathcal{L}_{bs} & = \mathcal{L}_{sb} = M_{rs} \cos (\theta_r - 120^{\circ}) \\
        \mathcal{L}_{cs} & = \mathcal{L}_{sc} = M_{rs} \cos (\theta_r + 120^{\circ}) \\
    \end{aligned}
    \label{eq:Eq8.18}
\end{equation}
...
\begin{equation}
    \begin{aligned}
        \mathcal{L}_{at} & = \mathcal{L}_{ta} = M_{rt} \cos (\theta_r + 90^{\circ}) = -M_{rt} \sin \theta_r \\
        \mathcal{L}_{bt} & = \mathcal{L}_{tb} = M_{rt} \cos (\theta_r + 90^{\circ} - 120^{\circ}) =  -M_{rt} \sin (\theta_r - 120^{\circ}) \\
        \mathcal{L}_{ct} & = \mathcal{L}_{tc} = M_{rt} \cos (\theta_r + 90^{\circ} + 120^{\circ}) =  -M_{rt} \sin (\theta_r + 120^{\circ}) \\
    \end{aligned}
    \label{eq_Eq8.19}
\end{equation}
...
\begin{equation}
    \begin{bmatrix}
        \varPsi_{a} \\[1ex] \varPsi_{b} \\[1ex] \varPsi_{c} \\[1ex] \varPsi_{f} \\[1ex] \varPsi_{s} \\[1ex] \varPsi_{t}
    \end{bmatrix}
    =
    \begin{bmatrix}

        \mathcal{L}_{aa} & \mathcal{L}_{ab} & \mathcal{L}_{ac} & \mathcal{L}_{af} & \mathcal{L}_{as} & \mathcal{L}_{at} \\[1ex]  
        \mathcal{L}_{ba} & \mathcal{L}_{bb} & \mathcal{L}_{bc} & \mathcal{L}_{bf} & \mathcal{L}_{bs} & \mathcal{L}_{bt} \\[1ex]
        \mathcal{L}_{ca} & \mathcal{L}_{cb} & \mathcal{L}_{cc} & \mathcal{L}_{cf} & \mathcal{L}_{cs} & \mathcal{L}_{ct} \\[1ex]  
        \mathcal{L}_{fa} & \mathcal{L}_{fb} & \mathcal{L}_{fc} & \mathcal{L}_{ff} & \mathcal{L}_{fs} & 0 \\[1ex]  
        \mathcal{L}_{sa} & \mathcal{L}_{sb} & \mathcal{L}_{sc} & \mathcal{L}_{sf} & \mathcal{L}_{ss} & 0 \\[1ex]  
        \mathcal{L}_{ta} & \mathcal{L}_{tb} & \mathcal{L}_{tc} & 0 & 0 & \mathcal{L}_{tt} 
    \end{bmatrix}
    \begin{bmatrix}
        i_{a} \\[1ex] i_{b} \\[1ex] i_{c} \\[1ex] i_{f} \\[1ex] i_{s} \\[1ex] i_{t}
    \end{bmatrix}
    \label{eq:Eq8.20}
